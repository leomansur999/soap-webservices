...
@WebService(endpointInterface = "vinhicola.VinhicolaServer")
public class VinhicolaServerImpl implements VinhicolaServer {
    @Override
    ...
    public Vinho pesquisarPreco(String nome) {
        ...
        if (vinho1.getNome().equals(nome)) {
            System.out.print("===> O vinho procurado foi: " + vinho1.getNome());
            return vinho1;
        } else if (vinho2.getNome().equals(nome)) {
            System.out.print("===> O vinho procurado foi: " + vinho2.getNome());
            return vinho2;
        }
        System.out.print("===> Retornou produto vazio");
        return new Vinho();
    }
}
